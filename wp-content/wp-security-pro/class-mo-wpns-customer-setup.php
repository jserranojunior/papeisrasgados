<?php
/** miniOrange enables you to secure your WP websites using WP Security Pro.
...
class Mo_Wpns_Customer{
	...
	*/
	...
	function create_customer(){
		...
		$fname = get_option('mo_wpns_admin_fname');
		$lname = get_option('mo_wpns_admin_lname');
		$companyName = get_option('mo_wpns_company');
