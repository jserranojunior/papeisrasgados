...
$url =  $this->curPageURL();
$excerpt= substr(strip_tags(get_the_excerpt()), 0, 30 );
...
<div class='apss-social-share-sidebar apss-theme-<?php echo $theme; ?> <?php if($counter =='1'){ ?> counter-enable <?php } ?>  clearfix apss-sidebar-<?php echo $position; ?>'>
<?php
global $post;
$title=get_the_title();
...
//Counter not available for digg, tumblr, xing, weibo
	...
	if( intval($value)=='1' ){
		switch($key){
			...
			<div class='apss-pinterest apss-single-icon'>
				<a title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' href='javascript:void((function()%7Bvar%20e=document.createElement(&apos;script&apos;);e.setAttribute(&apos;type&apos;,&apos;text/javascript&apos;);e.setAttribute(&apos;charset&apos;,&apos;UTF-8&apos;);e.setAttribute(&apos;src&apos;,&apos;http://assets.pinterest.com/js/pinmarklet.js?r=&apos;+Math.random()*99999999);document.body.appendChild(e)%7D)());'>
					<div class='apss-icon-block clearfix'>
			...
			<a title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
				<div class='apss-icon-block clearfix'>
					...
					<span class='apss-share'><?php if(isset($options['share_texts']['common-short-text']) && $options['share_texts']['common-short-text'] !='' ){ echo $options['share_texts']['common-short-text']; }else{ echo "Share"; } ?></span>
						...
						<?php /* if(isset($counter) && $counter=='1'){ ?>
						<div class='count' data-url='<?php echo $url;?>' data-social-network='<?php echo $key;?>'>Loading...</div>
						<?php }  */ ?>
			</a>
			</div>
